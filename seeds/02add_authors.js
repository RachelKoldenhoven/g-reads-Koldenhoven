...
exports.seed = function(knex, Promise) {
  return Promise.join(
    ...
    knex('authors').insert({
      ...
      picture_url: 'https://s3-us-west-2.amazonaws.com/assessment-images/galvanize_reads/photos/alex_martelli.jpg',
      book_id: 1
    }),
    knex('authors').insert({
      first_name: 'Anna',
      ...
      picture_url: 'https://s3-us-west-2.amazonaws.com/assessment-images/galvanize_reads/photos/anna_ravenscroft.jpg',
      book_id: 1
    }),
    knex('authors').insert({
      first_name: 'Steve',
      ...
      picture_url: 'https://s3-us-west-2.amazonaws.com/assessment-images/galvanize_reads/photos/steve_holden.jpg',
      book_id: 1
    }),
    knex('authors').insert({
      first_name: 'Allen B.',
      ...
      picture_url: 'https://s3-us-west-2.amazonaws.com/assessment-images/galvanize_reads/photos/allen_downey.jpg',
      book_id: 2
    }),
    knex('authors').insert({
      first_name: 'Bonnie',
      ...
      picture_url: 'https://s3-us-west-2.amazonaws.com/assessment-images/galvanize_reads/photos/bonnie_eisenman.jpg',
      book_id: 3
    }),
    knex('authors').insert({
      first_name: 'Kyle',
      ...
      picture_url: 'https://s3-us-west-2.amazonaws.com/assessment-images/galvanize_reads/photos/kyle_simpson.jpg',
      book_id: 4
    })
  );
};
